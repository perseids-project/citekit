/* Services */
	...
	var citekit_var_qs_GetObjectPlus = "?req=GetObjectPlus&request=GetObjectPlus&urn=";
	var citekit_var_qs_GetImagePlus = "?request=GetImagePlus&urn=";
	var citekit_var_qs_GetBinaryImage = "?request=GetBinaryImage&urn=";
	var citekit_var_qs_ICT = "index.html?urn=";


			var scripts = document.getElementsByTagName('script');
			var lastScript = scripts[scripts.length - 1];
			var jsURL = (lastScript.src);
			var rootURL = $('#citekit-sources').attr('data-baseurl') || jsURL.substring(0,jsURL.indexOf('/js'));
